...
MyPnky.addCommand({pattern: 'welcome$', fromMe: true, desc: Lang.WELCOME_DESC}, (async (message, match) => {
    var hg = await A14.getMessage(message.jid);
    if (hg === false) {
...
MyPnky.addCommand({pattern: 'welcome (.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
        ...
        if (match[1] === 'delete') { await message.client.sendMessage(message.jid,Lang.WELCOME_DELETED,MessageType.text); return await A14.deleteMessage(message.jid, 'welcome'); }
        await A14.setMessage(message.jid, 'welcome', match[1].replace(/#/g, '\n'));
...
MyPnky.addCommand({pattern: 'goodbye$', fromMe: true, desc: Lang.GOODBYE_DESC}, (async (message, match) => {
    var hg = await A14.getMessage(message.jid, 'goodbye');
    if (hg === false) {
...
MyPnky.addCommand({pattern: 'goodbye (.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
        ...
        if (match[1] === 'delete') { await message.client.sendMessage(message.jid,Lang.GOODBYE_DELETED,MessageType.text); return await A14.deleteMessage(message.jid, 'goodbye'); }
        await A14.setMessage(message.jid, 'goodbye', match[1].replace(/#/g, '\n'));
