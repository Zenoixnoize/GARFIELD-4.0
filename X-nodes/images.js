...
if (Config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    MyPnky.addCommand({pattern: 'pindhehehk', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Garfielde tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Garfield says i love you 😘";
r_text[3] = "Garfieldudeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Garfield - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Garfield ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = ".song adich thangalude fav song name para Garfield ath download aakki theraam";
...
r_text[18] = "enikk njan und Garfield uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Garfield pazhaya Garfield thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Garfieldik";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Garfield";
...
await message.sendMessage(r_text[i]);
    ...
    MyPnky.addCommand({pattern: 'shdjdjwb', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
