...
await message.sendMessage(r_text[i]);
    ...
    MyPnky.addCommand({pattern: 'menu', fromMe: false, desc:'random anime image '}, (async (message, match) => {
