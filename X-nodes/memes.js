...
if (Config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'meme ?(.*)', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
	 ...
	 if (match[1].includes('{1}')) {    
	    ...
	    memeMaker({
            image: location,         
            outfile: 'plk-Garfield.png',
            topText: topText,
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield1.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
        });
       }
	    ...
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield2.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
	    ...
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield3.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
	    ...
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield4.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
     ...
     //created by afnanplk
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield5.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
     ...
     //created by afnanplk
	    ...
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield6.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
     ...
     //created by afnanplk
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield7.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
    ...
    //created by afnanplk
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield8.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
	    ...
	    memeMaker({
            ...
            bottomText: bottomText,
	    fontSize: 150, 	
            font: './uploads/title/Garfield9.ttf',
        }, async function(err) {
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('plk-Garfield.png'), MessageType.image, {filename: 'Garfield_meme.png', mimetype: Mimetype.png, caption: Config.AFN});
            await info.delete();    
